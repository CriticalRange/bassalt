...
// Shader locations: 0=position, 1=color, 2=uv2
...
// Vertex format: POSITION_COLOR_LIGHTMAP
// Note: uv2 is at location 2, not 3, because this format has no uv0
struct VertexInput {
    @location(0) position: vec3<f32>,
    @location(1) color: vec4<f32>,
    @location(2) uv2: vec2<f32>,  // Lightmap coordinates
}
