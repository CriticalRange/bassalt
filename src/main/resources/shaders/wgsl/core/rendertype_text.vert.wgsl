...
// Converted from rendertype_text.vsh
// Simplified to work with position_tex_color vertex format
...
// Utility functions for fog distance
...
fn main_vs(in: VertexInput) -> VertexOutput {
    ...
    // For text, we just use the color directly (simplified lightmap)
